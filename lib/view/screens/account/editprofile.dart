...
import 'package:ecommerce/view/widget/settingwidget/shimmermyaccount.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<MyaccountConimble>(
      builder: (myaccountConimble) => Scaffold(
        ...
        body: myaccountConimble.statueRequest == StatueRequest.loading
            ? HandlingVieweditprofile()
            : Form(
                key: myaccountConimble.formstatekey,
                child: Padding(
                  padding: EdgeInsets.symmetric(
                      horizontal: AppConstans.Width * 0.05),
                  child: Column(
                    children: [
                      Row(
                        children: [
                            ...
                            children: [
                              CircleContainerImage(
                                image: myaccountConimble.isimagechosen
                                    ? FileImage(
                                        File(myaccountConimble.image!.path))
                              ...
                              Positioned(
                                ...
                                child: myaccountConimble.isimagechosen == false
                                    ? ShowBottomBar(
                                        camera:
                                            myaccountConimble.PickFromCamera,
                                        gallery:
                                            myaccountConimble.PickFromGallery,
                                      )
                                    : Container(
